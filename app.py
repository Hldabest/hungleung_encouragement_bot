#this is a bot to encourage everyone
print("Title of program: Hung Leung Encouragement bot")
print()
while True:
  ...
  for each_word in list_of_words:
    ...
    if each_word == "angry":
      ...
      encouragement_list.append("that you can always talk to someone else you trust")
      counter += 1
    if each_word == "lonely":
      feelings_list.append("lonely")
      encouragement_list.append("you can always talk to someone online")
      counter += 1
    if each_word == "excited":
      feelings_list.append("excited")
      encouragement_list.append("to have fun")
      counter += 1
    if each_word == "curious":
      feelings_list.append("curious")
      encouragement_list.append("to stay curious and discover more")
      counter += 1
    if each_word == "happy":
